...
function (pre_toluapp TARGET_DIR)
	...
	file (GLOB_RECURSE FILE_LIST "${BASE_DIR}/${TARGET_DIR}/tolua_*.cpp")
	foreach (F ${FILE_LIST})
		file (REMOVE ${F})
		message (removed\ file\ ${F})
	endforeach ()

	file (GLOB_RECURSE FILE_LIST "${BASE_DIR}/${TARGET_DIR}/*.pkg")
	...
	file (GLOB_RECURSE FILE_LIST "${BASE_DIR}/${TARGET_DIR}/*.epkg")
	foreach (PKG_FILE ${FILE_LIST})
		get_filename_component (FILE_NAME ${PKG_FILE} NAME_WE)
		get_filename_component (FILE_PATH ${PKG_FILE} DIRECTORY)
		execute_process (
