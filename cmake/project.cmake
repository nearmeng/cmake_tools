...
function (post_project)
	...
	if (TARGET_TYPE STREQUAL "STATIC")
		if (ARGV0)
			set(OUTPUT_DIR ${ARGV0})
		else()
			set(OUTPUT_DIR ${BASE_DIR}/lib)
		endif()

		set_target_properties (${TARGET_NAME} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY ${OUTPUT_DIR})
		set_target_properties (${TARGET_NAME} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY_DEBUG ${OUTPUT_DIR})
		set_target_properties (${TARGET_NAME} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY_RELEASE ${OUTPUT_DIR})
	elseif (TARGET_TYPE STREQUAL "DYNAMIC")
		if (ARGV0)
			set(OUTPUT_DIR ${ARGV0})
		else()
        ...
        if(MSVC)
		    ...
		    set_target_properties (${TARGET_NAME} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_DEBUG ${OUTPUT_DIR})
		    set_target_properties (${TARGET_NAME} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_RELEASE ${OUTPUT_DIR})
        else()
	...
	elseif (TARGET_TYPE STREQUAL "RUNTIME")
		if (ARGV0)
			...
			set(OUTPUT_DIR ${BASE_DIR}/bin/${TARGET_NAME})
		endif()
